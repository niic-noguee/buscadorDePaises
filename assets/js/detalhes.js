    ...
    try {
        document.getElementById("countryDetails").innerHTML = `
            <div style="text-align: center; padding: 40px;">
                ...
                <p style="margin-top: 20px; color: #4fc3f7;">Carregando informações do país...</p>
            </div>
        `;
        ...
        document.getElementById("countryDetails").innerHTML = `
            ...
            <div class="country-info-grid">
                ...
                <div class="country-info-item">
                    ...
                    <p>${country.borders.length} países</p>
                </div>
                ` : ''}
            </div>
            
            <div class="modal-actions">
                <a href="https://www.google.com/maps?q=${country.latlng[0]},${country.latlng[1]}" target="_blank">
                ...
                <a href="${country.maps.googleMaps}" target="_blank" style="margin-left: 10px;">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
        ...
        document.getElementById("countryDetails").innerHTML = `
            <div style="text-align: center; padding: 40px; color: #ff6b6b;">
                ...
                <h3 style="margin-top: 15px;">Erro ao carregar detalhes</h3>
